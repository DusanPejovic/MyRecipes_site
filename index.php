    ...
    <div id="mainDiv">
        <div id="mainDiv1">
            <div id="frontPage" class="text-center mt-5" style="padding: 2% ">
                <img id="logo" src="Pictures/myrecipeslogo.png" alt="logo" class="mt-5">
                ...
                <div class="collapse" id="recipes">
                    <div class="row">
                        ...
                        <div id="r_list" class="col-md-6 col-12">
                            <h1 class="mt-5 mb-5">Recipes</h1>
                            <ul style="overflow-y:auto">
                                <li>
                                    <img src="Pictures/trpeza.jpg" alt="">
                                    <p>recipe</p>
                                </li>
                                <li>
                                    <img src="Pictures/trpeza.jpg" alt="">
            ...
            <div id="carousel" class="carousel slide d-md-block d-none text-center" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="Pictures/trpeza.jpg" alt="img1">

                    </div>
                    <div class="carousel-item">
                        <img src="Pictures/pica.jpg" alt="img2">

                    </div>
                    <div class="carousel-item">
                        <img src="Pictures/trpeza2.jpg" alt="img3">
            ...
            <div class="d-md-none">
                <img style="height: 300px;width: 100%;" src="Pictures/trpeza2.jpg" alt="img3">
            </div>
        </div>
    </div>
</body>
